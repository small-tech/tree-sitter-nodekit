...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_element, 3),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_element, 3),
  ...
  [265] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_get_element, 3),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_get_element, 3),
  ...
  [309] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_element, 2),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_element, 2),
  [313] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_script_element, 2),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_element, 2),
  [317] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_await_end_expr, 4),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_await_end_expr, 4),
  [321] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_get_element, 2),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_get_element, 2),
